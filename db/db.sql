...
CREATE SCHEMA IF NOT EXISTS `sql238823` DEFAULT CHARACTER SET utf8 ;
USE `sql238823` ;

-- -----------------------------------------------------
-- Table `sql238823`.`Nombre`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sql238823`.`Nombre` (
...
-- -----------------------------------------------------
-- Table `sql238823`.`Apellido`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sql238823`.`Apellido` (
...
-- -----------------------------------------------------
-- Table `sql238823`.`Persona`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sql238823`.`Persona` (
  ...
  CONSTRAINT `fk_Persona_Nombre1`
    ...
    REFERENCES `sql238823`.`Nombre` (`idNombre`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `sql238823`.`Empresa`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sql238823`.`Empresa` (
  ...
  CONSTRAINT `fk_Empresa_Persona1`
    ...
    REFERENCES `sql238823`.`Persona` (`idPersona`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `sql238823`.`Trabajador`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sql238823`.`Trabajador` (
...
-- -----------------------------------------------------
-- Table `sql238823`.`Servicio`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sql238823`.`Servicio` (
  ...
  CONSTRAINT `fk_Servicio_Empresa1`
    ...
    REFERENCES `sql238823`.`Empresa` (`idEmpresa`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Servicio_Trabajador1`
    FOREIGN KEY (`Trabajador`)
    REFERENCES `sql238823`.`Trabajador` (`idTrabajador`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `sql238823`.`Articulo`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sql238823`.`Articulo` (
...
-- -----------------------------------------------------
-- Table `sql238823`.`Proveedor`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sql238823`.`Proveedor` (
  ...
  CONSTRAINT `fk_Proveedor_Articulo1`
    ...
    REFERENCES `sql238823`.`Articulo` (`idArticulo`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `sql238823`.`Articulo_has_Servicio`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sql238823`.`Articulo_has_Servicio` (
  ...
  CONSTRAINT `fk_Articulo_has_Servicio_Servicio1`
    ...
    REFERENCES `sql238823`.`Servicio` (`idCliente`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `sql238823`.`Forma_de_Pago`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sql238823`.`Forma_de_Pago` (
...
-- -----------------------------------------------------
-- Table `sql238823`.`Proveedor_has_Forma_de_Pago`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sql238823`.`Proveedor_has_Forma_de_Pago` (
...
-- -----------------------------------------------------
-- Table `sql238823`.`Forma_de_Pago_has_Trabajador`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sql238823`.`Forma_de_Pago_has_Trabajador` (
  `Forma_de_Pago_idForma_de_Pago` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `sql238823`.`Servicio_has_Forma_de_Pago`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sql238823`.`Servicio_has_Forma_de_Pago` (
  `Servicio_idCliente` INT NOT NULL,
  `Forma_de_Pago_idForma_de_Pago` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `sql238823`.`Apellido_has_Persona`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sql238823`.`Apellido_has_Persona` (
  ...
  CONSTRAINT `fk_Apellido_has_Persona_Apellido1`
    ...
    REFERENCES `sql238823`.`Apellido` (`idApellido`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
